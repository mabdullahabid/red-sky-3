"""
Django settings for red_sky_3 project.
...
WSGI_APPLICATION = 'red_sky_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_sky_3 API",
    "DESCRIPTION": "API documentation for red_sky_3 App",
    "VERSION": "v1",
}
